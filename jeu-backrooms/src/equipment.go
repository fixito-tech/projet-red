...
// String renvoie le nom affiché de l'emplacement : Tête, Torse ou Pieds.
...
// Set et Get passent par lui pour ne pas répéter le switch.
...
func (e Equipment) Get(slot EquipmentSlot) *EquipmentItem {
	return *e.slotPtr(slot)
}

// worn renvoie les pièces réellement portées (les emplacements vides
// sont ignorés).
func (e Equipment) worn() []*EquipmentItem {
